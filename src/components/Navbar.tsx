...
export default function Navbar() {
  ...
  return (
    <nav className="bg-white w-full">
      <div className="bg-white flex items-center font-medium justify-between">
        <div
          id="logo-container"
          className="bg-white z-50 md:w-auto w-full flex justify-between"
        >
          <img
        ...
        <ul
          className={`
            md:hidden bg-white fixed w-full top-0 overflow-y-hidden bottom-0 py-20 pl-4
